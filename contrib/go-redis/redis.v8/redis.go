...
func (ddh *dataDogHook) AfterProcess(ctx context.Context, cmd redis.Cmder) (err error) {
...
func (ddh *dataDogHook) AfterProcessPipeline(ctx context.Context, cmds []redis.Cmder) (err error) {
	var span tracer.Span
	span, _ = tracer.SpanFromContext(ctx)
	var finishOpts []ddtrace.FinishOption
